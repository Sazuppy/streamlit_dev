...
st.markdown(
    """
    **О себе:** я являюсь начинающим специалистом в сфере Data Science. Начал обучение в середине 2022г. с основ Python на курсах:
    ...
    Хочу представить проект на базе [Streamlit](https://streamlit.io/) для наглядной демонстрации работы моделей машинного обучения, которые созданы на основе учебных проектов в процессе
    ...
    Так же хочу познакомить с отдельным проектом компьютерного зрения, который создан на основе учебного проекта Яндекс Практикум.   
    [Определение возраста человека по фотографии](https://age-determination.streamlit.app/)
